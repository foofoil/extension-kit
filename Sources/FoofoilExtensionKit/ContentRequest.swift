...
public struct ExtensionResource: Codable, Equatable, Sendable {
    public let url: URL
    public let securityScopedBookmark: Data?

    public init(url: URL, securityScopedBookmark: Data? = nil) {
        self.url = url
        self.securityScopedBookmark = securityScopedBookmark
    }

    public static func sandboxed(url: URL) -> ExtensionResource {
...
public enum ContentRequest: Codable, Equatable, Sendable {
    ...
    public var resources: [ExtensionResource] {
        switch self {
...
public final class ExtensionResourceAccessScope {
    private var accessedURLs: [URL] = []

    public init(request: ContentRequest) {
